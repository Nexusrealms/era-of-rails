...
public class RailwaysItems {
    ...
    public static final Item COPPER_MINECART = create("copper_minecart", settings -> new MinecartItem(RailwaysEntities.COPPER_MINECART, settings), new Item.Settings().maxCount(1), ItemGroups.REDSTONE, (fabricItemGroupEntries, minecartItem) -> fabricItemGroupEntries.addAfter(REDSTONE_BLOCK_MINECART, minecartItem));
