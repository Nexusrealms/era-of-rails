...
public class InputCartScreen extends Screen {
    private static final Identifier BACKGROUND = NewRailways.id("textures/gui/input_cart_screen_background.png");
    private static final Identifier DISABLED = NewRailways.id("textures/gui/input_switch_inactive.png");
    private static final Identifier DISABLED_ON = NewRailways.id("textures/gui/input_switch_inactive_on.png");
    private static final Identifier SWITCH = NewRailways.id("textures/gui/input_switch.png");
    private static final Identifier SWITCH_ON = NewRailways.id("textures/gui/input_switch_on.png");
    private static final Identifier SWITCH_NEXT = NewRailways.id("textures/gui/input_switch_next.png");
    private static final Identifier SWITCH_ON_NEXT = NewRailways.id("textures/gui/input_switch_on_next.png");
