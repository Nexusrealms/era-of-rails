...
import de.nexusrealms.eraofrails.entity.types.*;
...
public class RailwaysEntities {
    ...
    public static <T extends Entity> EntityType<T> create(String name, EntityType.Builder<T> builder){
        RegistryKey<EntityType<?>> key = RegistryKey.of(RegistryKeys.ENTITY_TYPE, EraOfRails.id(name));
        return Registry.register(Registries.ENTITY_TYPE, key, builder.build(key));
    }
    public static void init(){
        FabricTrackedDataRegistry.register(EraOfRails.id("minecart_reference"), MINECART_REFERENCE);
    }
    public static class Tags {
        public static final TagKey<EntityType<?>> COPPER_MINECARTS = TagKey.of(RegistryKeys.ENTITY_TYPE, EraOfRails.id("copper_minecarts"));
    }
}
