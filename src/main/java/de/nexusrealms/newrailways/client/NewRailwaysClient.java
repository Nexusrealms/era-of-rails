...
public class NewRailwaysClient implements ClientModInitializer {
    public static final Identifier COPPER_MINECART_TEXTURE = NewRailways.id("textures/entity/copper_minecart.png");
